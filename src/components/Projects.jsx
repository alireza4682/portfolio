...
const Projects = () => {
  return (
    <section id="projects" className="pt-48 pb-48">
      ...
      <div className="fext justify-center">
        <motion.div
          className="sm:grid sm:grid-col-3"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={Container}
        >
          <div
            className="flext justify-center text-center items-center p-10 bg-red max-w-[400px] max-h-[400px]
          ...
          <div
            className="flext justify-center text-center items-center p-10 bg-blue max-w-[400px] max-h-[400px]
                text-2xl font-serif font-semibold"
          >
