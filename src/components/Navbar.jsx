...
const Navbar = ({ isTopOfPage, selectedPage, setSelectedPage }) => {
  ...
  return (
    <nav
      className={`${navebarBackground} z-40 fixed top-0 py-1 w-full`}
      ref={awayRef}
    >
      <div className="flex items-center justify-between mx-auto w-5/6 ">
        ...
        {!isAboveSmallScreen && (
          <div
            className={`fixed right-1 top-16 h-fit bg-stone-600/80 backdrop-blur-2xl w-[200px] py-4 rounded-lg ${
              !isMenuToggled ? "scale-0 -translate-y-1/2" : "scale-100"
            } transition-all duration-300`}
          >
            <div
              className={`flex flex-col gap-5 items-center text-xl text-stone-200 font-serif h-full ${
